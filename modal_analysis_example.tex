...
This melody will become familiar to those who sing the Mass regularly, for it is largely shared with the introit \textit{Salve, sancta Parens,} sung for Masses taken from the Common of the Blessed Virgin Mary, albeit in a slightly simpler, less ornamented form. The Mother of God is a part of the holy season, if more indirectly, as we pass from the Nativity where she is truly a main character to one where she begins to fade into the background, although not entirely, for she herself initiates the miracle of Cana. But to be in the background is for the humbled to be exalted, as she is revealed as Advocate and Mediatrix of All Graces for her children. Ditto the Forerunner, the subject of the verse on which this is loosely based or rather from which it is adapted. ``I must decrease, so that he might increase.'' John is a major figure of the season of Advent and in the temporal cycle last figures as a main character in the mystery of the Epiphany as he baptizes his divine relative in the waters of the Jordan. Then he steps aside for the Redemption to completely unfold by the one who is its actor and indeed cause.
...
\textit{potéstas:} What is given in the Vatican Edition as a distropha is thetic no matter how it is sung, whereas the pes on the tonic accent is arsic, followed by an obligatory thesis on the dotted punctum to end the incise.
...
We might wish to consider lengthening and swelling in volume not only on the first note of the podatus, its base or foot (the origin of the name \textit{pes}) but also the second, such as at \textit{manu} and \textit{potéstas.}
